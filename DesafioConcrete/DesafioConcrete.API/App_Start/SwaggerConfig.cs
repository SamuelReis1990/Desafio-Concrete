...
namespace DesafioConcrete.API
{
    public class SwaggerConfig
    {
                ...
                .EnableSwagger(c =>
                    {
                        ...
                        //                        
                        c.SingleApiVersion("v1", "Desafio Concrete API")
                          .Description("API para o desafio da Concrete <br /><br />build: " + Assembly.GetExecutingAssembly().GetName().Version.ToString())
                          .Contact(cc => cc
                          .Email("samuelreis.1990@gmail.com"));
        ...
        {
            return String.Format(@"{0}\App_Data\Swagger.XML", System.AppDomain.CurrentDomain.BaseDirectory);
        }
